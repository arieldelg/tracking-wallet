...
const MyBillComponent = ({
  ...
  const className = twMerge(`
    bg-customBGDark1 rounded-2xl ring-2 px-8 py-5 w-full max-w-[800px] text-lg relative flex flex-col justify-between animate-fadeInBillModal m-auto ultraWide:px-7 ultraWide:py-6 ultraWide:max-h-[650px] ultraWide:max-w-[700px] ultraWide:text-xl 2xUltraWide:max-h-[680px] ${classNameContainer}
    `);
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-flow-col xl:grid-cols-[100px_auto] 2xl:grid-cols-[140px_auto] ultraWide:grid-cols-[150px_auto] items-start gap-10 xl:py-4">
        {/* 
      // * seccion 1 ( type, date, tag )
      */}
        <div className="space-y-1 xl:text-[16px] 2xl:text-lg  ultraWide:text-xl leading-4">
    ...
    // * seccion 2 ( note )
    */}
        <div className="xl:space-y-1 xl:text-[16px] xl:tracking-tight 2xl:space-y-1 2xl:text-lg ultraWide:text-xl w-full leading-6">
      ...
      */}
          ...
          <div
            className={`w-full ultraWide:w-full grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 py-2 ultraWide:gap-x-2 gap-y-4 items-center justify-items-center overflow-auto scrollbar rounded-md  ${
              activeNote?.images?.length === 0
                ? "h-[80px] ultraWide:h-[130px]"
                : "xl:h-[200px] 2xl:h-[250px] ultraWide:h-[278px] 2xUltraWide:h-[220px]"
            }`}
          >
